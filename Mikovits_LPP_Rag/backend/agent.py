...
class RAGAgent:
    def __init__(self, db: RAGDatabase, model_name: str, max_iter: int, api_key: str):
        self.db = db
    ...
    def ask(self, question: str) -> dict:
        ...
        agent = Agent(
            ...
            goal='Answer questions about the NBA using the database',
            backstory='You are an expert who has access to a database with content about the NBA.',
            tools=[query_tool],
            llm=llm,
