# =============================================================================
# Database module for NBA RAG Assistant
# =============================================================================
...
class RAGDatabase:
    ...
    # Init class with db_path and model attributes
    ...
    # CREATE _load_model() method that stores model attribute
    def _load_model():
